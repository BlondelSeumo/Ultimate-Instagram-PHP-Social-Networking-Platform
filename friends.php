...
if ($ProfilePrivateAccount == '1' && $FriendStatus !== 'me' && $FriendStatus !== 'flwr' && $FriendStatus !== 'fri') {
    ...
    <!--Profile Image, some user informations FINISHED-->
       <div class="profile_friends_container">
              ...
              <!--MIDDLE STARTED-->
            <div class="cGcGK_fri">
                <div class="profile_f_container" id="morePostType" data-type="more_friends" data-profile="<?php echo $profileUserID; ?>">
                     <?php include "contents/profile_friends.php";?>
                  </div>
            </div>
            <!--MIDDLE FINISHED-->
       </div>
