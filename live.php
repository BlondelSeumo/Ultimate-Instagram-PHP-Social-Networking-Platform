		...
		<div id="remote-media">
			...
			<div id="live_post_comments" class="liv_comments_feed">
                <div class="live_comments_container">
					 ...
					 <div class="newDonatebox uinfSlideInUp dlimam" data-type="donateLiveFrm" data-u="<?php echo $profileUserID;?>">
                            <div class="fundraiserBox">
                              <div class="fundraiser"><div class="fundraiser_text">Live fundraiser</div><div class="fundraiser_note">This is for my sex job.</div></div>
                              <div class="fundraiser_me"><div class="fundrame">Donate</div></div>
                            </div>
                        </div>
