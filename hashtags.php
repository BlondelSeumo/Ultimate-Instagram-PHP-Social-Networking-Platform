...
<div class="th_middle">
 <div class="container"> 
      <!--MIDDLE STARTED-->
      <div class="cGcGK"> 
      <div class="HashTagTopHead">
          <div class="tagsHash">#</div>
          <div class="globalHashT">
            <div class="globalHashtResult">  #<?php echo $hashTag;?></div>
            <div class="peopletalkingabout"><?php echo $page_Lang['number_of_talking_about_this_hashtag'][$dataUserPageLanguage].' '.$Dot->Dot_CaltulateHashFromDatabase($hashTag);?></div>
           </div>
       </div>
