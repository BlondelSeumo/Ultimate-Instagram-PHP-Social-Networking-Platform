...
if($ChatUserOnlineOffline > $loggedTime) {
	...
	$VideoAudioButtons = '<div class="o_others_op_mini" onclick="video_call_manage(0, '.$toUserID.', 0);"><div class="o_other_i_wrapper_min">'.$Dot->Dot_SelectedMenuIcon('audio_call_icon').'</div></div><div class="o_others_op_mini"><div class="o_other_i_wrapper_min" onclick="video_call_manage(0,'.$toUserID.',1);">'.$Dot->Dot_SelectedMenuIcon('video_call_icon').'</div></div>'; 
} else { 
    $online='<span class="_2v6o timeago" title="'.$getLastTime.'"></span>';
	$VideoAudioButtons = '<div class="o_others_op_mini"><div class="o_other_i_wrapper_min" style="cursor: no-drop;">'.$Dot->Dot_SelectedMenuIcon('no_audio_call').'</div></div><div class="o_others_op_mini"><div class="o_other_i_wrapper_min" style="cursor: no-drop;">'.$Dot->Dot_SelectedMenuIcon('no_video_call').'</div></div>';
              ...
              <span class="o_chat_header_in">
                    ...
                    <div class="o_chat_header_options">
                         ...
                         <div class="o_chat_other_options"> 
                            ...
                            <div class="o_others_op_mini closeminichat">
                                 <a href="<?php echo $base_url;?>chat?with=<?php echo $ChatUserName;?>"><div class="o_other_i_wrapper_min"><?php echo $Dot->Dot_SelectedMenuIcon('chat_mini_other_page_icon');?></div></a>
                            </div>
                            <div class="o_others_op_mini closeminichat">
                                 <div class="o_other_i_wrapper_min mnsv"><?php echo $Dot->Dot_SelectedMenuIcon('close_icons');?></div>
                            </div>
