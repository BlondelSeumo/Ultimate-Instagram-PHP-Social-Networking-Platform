...
<span class="ex_text_post_container" id="<?php echo $dataPostID;?>" data-last="<?php echo $dataPostID;?>" data-id="<?php echo $dataPostID;?>" data-ui="<?php echo $dataPostUID;?>">
     <span class="ex_post_wrp ex_post_bor_right"> 
          <?php 
		  if($dataPostTitleText){
				  echo '<span class="ex_text_post_title theTit_'.$dataPostID.'" id="post_title'.$dataPostID.'" data-linkify="this" data-linkify-target="_target" data-trl="'.$dataPostTitleText.'">'.$dataPostTitleText.'</span>';
		 }
		 if($postTextDetails){
			       echo '<span class="ex_text_post_desc '.$longText.'" data-linkify="this" data-linkify-target="_target" data-trl="'.$postTextDetails.'">'.strip_unsafe(styletext($postTextDetails)).' '.$showMoreBtn.'</span>';
		 }
		 ?> 
     </span>
