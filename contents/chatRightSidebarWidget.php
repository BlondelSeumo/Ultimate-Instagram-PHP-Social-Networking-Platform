<div class="chatSidebar chatSidebarHide" id="fchatBox" data-type="chat">
                    ...
                    <?php   
					   ...
					   if($wChatUsers){
					      foreach($wChatUsers as $chU){
							   ...
							   $wcVerifiedUser = $chU['verified_user'];
							   $wcProUserType = $chU['pro_user_type'];
							   $wcverifiedBadge ='';
							   $wcProu = '';
							   if ($wcVerifiedUser == '1') {
								$wcverifiedBadge = $Dot->Dot_SelectedMenuIcon('verification_icon');
							   }
							   if ($wcProUserType == '1') {
								$wcProu = '<span class="p_prst" style="left: 28px;top: -4px;">' . $Dot->Dot_SelectedMenuIcon('pro_member') . '</span>';
							   }
							   ...
							   if($wcgetUnReadMessageCount != '0'){
							       $msgUnReadCount = '<div class="unreadMessageCount" id="unrm'.$wcUserID.'">'.$wcgetUnReadMessageCount.'</div>';
									...
									$chTreeMinutesAgo = time()-360; // Tree minutes ago
									$wcLoginStatus = '';
								...
								<div class="" style="width: 100%;display: inline-block;">         
									<span class="chu_box_user getminib" id="miniuser_<?php echo $wcUserID;?>" data-page="minibox" data-id="<?php echo $wcUserID;?>" data-user="<?php echo  $wcUserName;?>">  
										...
										<div class="chu_box_user_name truncate"><?php echo $wcUserFullName.$wcverifiedBadge;?></div>
					   ...
					   $MyOnlineFriends = $Dot->Dot_OnlineFriends($uid);
						 if($MyOnlineFriends){
							...
							foreach($MyOnlineFriends as $myonlineflwr){
								...
								$wcVerifiedUser = $myonlineflwr['verified_user'];
							    $wcProUserType = $myonlineflwr['pro_user_type'];
							    $wcverifiedBadge ='';
							    $wcProu = '';
							    if ($wcVerifiedUser == '1') {
								 $wcverifiedBadge = $Dot->Dot_SelectedMenuIcon('verification_icon');
							    ...
							    $MyLastLogin = $Dot->Dot_GetUserLastLoginForChat($MyonlineFriendUID);  
									...
									$MychTreeMinutesAgo = time()-360; // Tree minutes ago
									$MywcLoginStatus = '';
                                    ...
                                    <div class="hvr-bounce-to-right" style="width: 100%;display: inline-block;"> 
                                           <span class="chu_box_user getminib" data-page="minibox" data-id="<?php echo $MyonlineFriendUID;?>" data-user="<?php echo  $MyonlineFriendUserName;?>"> 
                                                 ...
                                                 <div class="chu_box_user_name truncate"><?php echo $MyonlineFriendUserFullName.$wcverifiedBadge;?></div>
