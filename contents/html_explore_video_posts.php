...
<span class="ex_text_post_container" id="<?php echo $dataPostID;?>" data-last="<?php echo $dataPostID;?>" data-id="<?php echo $dataPostID;?>" data-ui="<?php echo $dataPostUID;?>">
     <span class="ex_post_wrp ex_post_bor_right clr"> 
          <?php 
		...
		if($dataPostCreatedVideoID){
            ...
            if(does_url_exists($tumbImage) == true){
               $videoTumbnail = $tumbImage;
            }else{
               $videoTumbnail = $base_url.'uploads/images/safe_img.png';
            }
			   echo '
			   <div class="item column-video column-video-ex" id="videobox'.$dataPostID.'" data-id="'.$dataPostID.'">
			   ...
			   <!--Media Player STARTED-->
					<div class="media-wrapper videoPlayr" id="videoPlayer'.$dataPostID.'"> 
						<video class="vidchaVideo mejs__player el_'.$dataPostID.'" id="player'.$dataPostID.'" data-id="'.$dataPostID.'" width="100%" height="360"style="max-width:100%;" src="'.$videoS3Url.'" type="video/mp4" controls preload="none"></video>
					</div>
