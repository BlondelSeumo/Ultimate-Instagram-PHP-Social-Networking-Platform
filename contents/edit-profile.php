<div class="settings_form_container">
  ...
  <div class="set_box">
    ...
    <span class="set_input_box">
    <input type="text" class="inputField insta_font chng b_u" style="text-align:left; text-transform:lowercase;" id="register_username" value="<?php echo $dataUsername; ?>"/>
      <div class="alreadyexist e_u_w" style="display:none;"><div class="alreadyexist_in"><?php echo $page_Lang['username_already_in_use'][$dataUserPageLanguage]; ?></div></div>
      <div class="alreadyexist e_u_w_n" style="display:none;"><div class="alreadyexist_in"><?php echo $page_Lang['only_english_character'][$dataUserPageLanguage]; ?></div></div>
    </span>
  </div>
  <!--Setting Input Item FINISHED-->
  <!--Setting Imput Item STARTED-->
  ...
  <h1 class="settings_header" id="shoppingaddress">
    <?php echo $page_Lang['p_address_infos'][$dataUserPageLanguage]; ?> <span style="font-weight:300;font-size:12px;width:100%;padding-top:5px;">(<?php echo $page_Lang['need_for_market_shopping'][$dataUserPageLanguage]; ?>)</span>
  </h1>
  <!--OOOOOOOOOOOOOOOOOOOOO-->
  <!--Setting Imput Item STARTED-->
  <div class="set_box">
    <div class="set_box_title">
        <?php echo $page_Lang['p_u_full_name'][$dataUserPageLanguage]; ?>
    </div>
  ...
  <div class="set_box">
    <div class="set_box_title">
      <?php echo $page_Lang['u_p_phone_number'][$dataUserPageLanguage]; ?>
    </div>
  ...
  <div class="set_box">
    <div class="set_box_title">
      <?php echo $page_Lang['u_p_id_or_passkey'][$dataUserPageLanguage]; ?>
    </div>
  ...
  <div class="set_box">
    <div class="set_box_title">
      <?php echo $page_Lang['u_p_postcode'][$dataUserPageLanguage]; ?>
    </div>
  ...
  <div class="set_box">
    <div class="set_box_title">
      <?php echo $page_Lang['u_p_fulladdress'][$dataUserPageLanguage]; ?>
    </div>
  ...
  <div class="set_box">
    <div class="set_box_title">
      <?php echo $page_Lang['u_p_country'][$dataUserPageLanguage]; ?>
    </div>
  ...
  <div class="set_box">
    <div class="set_box_title">
      <?php echo $page_Lang['u_p_state'][$dataUserPageLanguage]; ?>
    </div>
    <div class="set_input_box">
      <!---->
  ...
  <div class="set_box">
    <div class="set_box_title">
    <?php echo $page_Lang['u_p_city'][$dataUserPageLanguage]; ?>
    </div>
    <div class="set_input_box">
      <!---->
...
$(document).ready(function(){
  ...
  $("body").on("click", ".save_personal_info", function(){
      ...
      var selectedGender = $("select#gender option").filter(":selected").val();;/*OK*/
      var selectedRelationShip =  $("select#relationshipu option").filter(":selected").val();/*OK*/
      <?php if ($sexualityFeature == '1') {?>var selectedSexuality = $("select#sexuality option").filter(":selected").val();/**/<?php }?>
      <?php if ($userHeightFeature == '1') {?>var selectedHeight = $("select#height option").filter(":selected").val();/**/<?php }?>
      <?php if ($userWeightFeature == '1') {?>var selectedWeight = $("select#weight option").filter(":selected").val();/**/<?php }?>
      <?php if ($userLifeStyleFeature == '1') {?>var selectedLifeStyle = $("select#life_style option").filter(":selected").val();/**/<?php }?>
      <?php if ($userChildrenFeature == '1') {?>var selectedChildren = $("select#children option").filter(":selected").val();/**/<?php }?>
      <?php if ($userSmokingFeature == '1') {?>var selectedSmokeHabit = $("select#smoke_habit option").filter(":selected").val();/**/<?php }?>
      <?php if ($userDrinkingFeature == '1') {?>var selectedDrinkingHabit = $("select#drinking_habit option").filter(":selected").val();/**/<?php }?>
      <?php if ($userBodyTypeFeature == '1') {?>var selectedBodyType = $("select#body_type option").filter(":selected").val();/**/<?php }?>
      <?php if ($userHairColorFeature == '1') {?>var selectedHairColor = $("select#hair_color option").filter(":selected").val();/**/<?php }?>
      <?php if ($userEyeColorFeature == '1') {?>var selectedEyeColor = $("select#eye_color option").filter(":selected").val();/**/<?php }?>
      var savePersonalInformation = 'f='+type
      +'&gen='+selectedGender
      <?php if ($sexualityFeature == '1') {?>+'&sex='+selectedSexuality<?php }?>
      <?php if ($userHeightFeature == '1') {?>+'&height='+selectedHeight<?php }?>
      <?php if ($userWeightFeature == '1') {?>+'&weight='+selectedWeight<?php }?>
      <?php if ($userLifeStyleFeature == '1') {?>+'&life='+selectedLifeStyle<?php }?>
      <?php if ($userChildrenFeature == '1') {?>+'&child='+selectedChildren<?php }?>
      <?php if ($userSmokingFeature == '1') {?>+'&smoke='+selectedSmokeHabit<?php }?>
      <?php if ($userDrinkingFeature == '1') {?>+'&drink='+selectedDrinkingHabit<?php }?>
      <?php if ($userBodyTypeFeature == '1') {?>+'&body='+selectedBodyType<?php }?>
      <?php if ($userHairColorFeature == '1') {?>+'&hair='+selectedHairColor<?php }?>
      <?php if ($userEyeColorFeature == '1') {?>+'&eye='+selectedEyeColor<?php }?>
...
$('body').delegate('#register_username', 'keyup', function() {
  ...
  timer = setTimeout(function() {
	 ...
	 if( userCheck.length < 3 ) {
		...
		$.ajax({
		  type: 'POST',
		  url: requestUrl + "requests/resetUsername.php",
		  data: data,
		  cache: false,
		  success: function(response) {
			if(response == 1){
