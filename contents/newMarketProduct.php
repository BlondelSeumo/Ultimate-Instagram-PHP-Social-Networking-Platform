...
$geocode = file_get_contents('https://maps.googleapis.com/maps/api/geocode/json?latlng=' . $LocationUserLatitude . ',' . $LocationUserLongitude . '&sensor=false&key=' . $dot_googleMapApi . '');
       ...
       <div class="post-modal-middle">
           ...
           <div class="write_post_information">
               ...
               <div class="global_post_box">
                   ...
                   <div class="warningNote w__curncys">Choose Product Currency</div>
               ...
               <!--Textarea FINISHED--> 
                <!--Input STARTED-->
               <div class="global_post_box">
                   <input type="text" class="title_prod" id="place" placeholder="<?php echo $page_Lang['write_place_address'][$dataUserPageLanguage];?>" value="<?php echo isset($formattedAddress) ? $formattedAddress : NULL;?>" >
               </div>
               <!--Input FINISHED-->
               <div class="global_post_box">
