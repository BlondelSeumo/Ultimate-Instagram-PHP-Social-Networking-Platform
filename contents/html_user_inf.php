...
$infUseVerifiedUser = isset($ud['verified_user']) ? $ud['verified_user'] : NULL;
...
$userVerified = '';
if ($infUseVerifiedUser == '1') {
	$userVerified = '<span class="mrEK_ Szr5J coreSpriteVerifiedBadge icons" style="display: inherit !important;" title="Doğrulanmış"></span>';
}
?>
...
<div class="uinfo_wrapper_ss uinfSlideInUp">
  <div class="inf_con_box">
   ...
   <div class="uinfAllContainer">
         ...
         <div class="uinfName"> <?php echo $infUserFulName; ?> <?php echo $userVerified; ?></div>
...
?>
             ...
             <div class="info_item_box _item_answer"><?php echo $infUserJobTitle;
echo $infUserJobCampanyName; ?></div>
