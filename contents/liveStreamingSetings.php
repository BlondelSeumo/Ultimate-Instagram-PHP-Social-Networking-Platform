<div class="lvSettingsContainer">
    <div class="lvStreamingWrapper">
        <div class="globalBoxHeader_Live"><?php echo $page_Lang['live_s_settings'][$dataUserPageLanguage];?> <div class="closeLset"><?php echo $Dot->Dot_SelectedMenuIcon('close_icons');?></div></div>
        <div class="lvSetC"> 
             <!---->
        ...
        <!---->
         <div class="globalBoxHeader_Live"><?php echo $page_Lang['live_s_video_filters'][$dataUserPageLanguage];?></div>
         <div class="lvSetC"> 
             <?php 
