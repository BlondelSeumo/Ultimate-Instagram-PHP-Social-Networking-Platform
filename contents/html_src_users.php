...
<div class="filter_users_icon"><?php echo $Dot->Dot_SelectedMenuIcon('filter_user'); ?></div><?php echo $page_Lang['filter_search'][$dataUserPageLanguage]; ?>
</div>
<div class="filter_users waves-effect waves-light filusClear">
<div class="filter_users_icon"><?php echo $Dot->Dot_SelectedMenuIcon('filter_user'); ?></div><?php echo $page_Lang['clear_filter_search'][$dataUserPageLanguage]; ?>
</div>
...
$("body").on("click",".filusClear", function(){
	  if ($('div.search_user_filter_container').length === 0) {
		  var types = 'clearfilterusers';
	      var data= 'f='+types;
	  $.ajax({
			type: "POST",
			url: requestUrl + "requests/activity",
