...
$hamburgerMenu = $Dot->Dot_SelectedMenuIcon('hamburger_menu');
?>
...
<?php }?>
<link rel="stylesheet" id="style_mode" href="<?php echo $base_url; ?>css/<?php echo $styleMode; ?>.css?v=<?php echo $scriptVersion;?>">
<?php if ($page == 'admin') {?><link rel="stylesheet" href="<?php echo $base_url; ?>admin/css/admin<?php echo $styleMode; ?>.css?v=<?php echo $scriptVersion; ?>" media="screen,projection"><?php }?>
...
<link rel="stylesheet" href="<?php echo $base_url; ?>css/bfaf/images-compare.css?v=<?php echo $scriptVersion;?>">
...
<link rel="stylesheet" href="<?php echo $base_url; ?>css/fluidplayer.min.css">
<link rel="stylesheet" href="<?php echo $base_url; ?>css/swiper/swiper.css">
<?php if ($page == 'marketplace') {?>
<link rel="stylesheet" href="<?php echo $base_url; ?>css/marketplace_<?php echo $styleMode; ?>.css?v=<?php echo $scriptVersion; ?>">
<link rel="stylesheet" href="<?php echo $base_url; ?>css/swiper/swiper.css">
<?php }?>
<?php if ($page == 'explore') {?>
...
if (isset($token_id)) {
	if (isset($_SESSION['token_id']) != $token_id) {
...
<script type="text/javascript" src="<?php echo $base_url; ?>js/recorderJs/recorder.js"></script>
<script type="text/javascript" src="<?php echo $base_url; ?>js/timeago/<?php echo isset($page_Lang['timeagojs'][$dataUserPageLanguage]) ? $page_Lang['timeagojs'][$dataUserPageLanguage] : $page_Lang['timeagojs']['english']; ?>"></script>
...
<script type="text/javascript" src="<?php echo $base_url; ?>js/fluidplayer.min.js"></script>
...
<?php
if ($videoSoundOpenStatus == true) {?>
soundStatusVideo = 'false';
<?php } else {?>
soundStatusVideo = 'true';
<?php }?>
...
<script type="text/javascript" src="<?php echo $base_url; ?>js/oobenn.js?v=<?php echo $scriptVersion; ?>"></script>
...
<?php }?>
<?php if ($page == 'admin') {?>
	<script type="text/javascript" src="<?php echo $base_url; ?>admin/js/admin.js?v=134<?php //echo $scriptVersion;?>"></script>
...
<?php
if ($agoreStatus == '1') {?>
<script src="<?php echo $base_url; ?>js/agora.js"></script>
<link href="<?php echo $base_url; ?>js/video/video-js.css" rel="stylesheet" />

<!-- If you'd like to support IE8 (for Video.js versions prior to v7) -->
<script src="<?php echo $base_url; ?>js/video/videojs-ie8.min.js"></script>
<script src="<?php echo $base_url; ?>js/video/video.js"></script>
<script type="text/javascript">
...
<?php }?>
<?php if ($page == 'liveStreaming' && $liveStreamingVideoWithStatus == '1') {?>
<style type="text/css">
.liv_comments_feed {
...
background-image:url(<?php echo $base_url; ?>css/img/livBg.png);
}
.liv_vid_cont div {
max-width:600px;
margin:0px auto;
...
<link rel="stylesheet" href="<?php echo $base_url; ?>css/filters.css">
<?php }?></head>
<?php $actual_link = (isset($_SERVER['HTTPS']) && $_SERVER['HTTPS'] === 'on' ? "https" : "http") . "://{$_SERVER['HTTP_HOST']}{$_SERVER['REQUEST_URI']}";?>
<body id="the_page" data-current="<?php echo $actual_link; ?>">
<div class="note_1"><div class="newWarningDisplay"><?php echo isset($page_Lang['please_try_again_later'][$dataUserPageLanguage]) ? $page_Lang['please_try_again_later'][$dataUserPageLanguage] : $page_Lang['please_try_again_later']['english']; ?></div></div>
<div class="note_2"><div class="newWarningNoteDisplay"><?php echo isset($page_Lang['you_can_not_send_empty_text_post'][$dataUserPageLanguage]) ? $page_Lang['you_can_not_send_empty_text_post'][$dataUserPageLanguage] : $page_Lang['you_can_not_send_empty_text_post']['english']; ?></div></div>
<div class="note_3"><div class="newnote_3"><?php echo isset($page_Lang['you_should_upload_photo'][$dataUserPageLanguage]) ? $page_Lang['you_should_upload_photo'][$dataUserPageLanguage] : $page_Lang['you_should_upload_photo']['english']; ?></div></div>
<div class="note_4"><div class="newnote_4"><?php echo isset($page_Lang['yous_shoud_upload_vide_here'][$dataUserPageLanguage]) ? $page_Lang['yous_shoud_upload_vide_here'][$dataUserPageLanguage] : $page_Lang['yous_shoud_upload_vide_here']['english']; ?></div></div>
<div class="note_5"><div class="newnote_4"><?php echo isset($page_Lang['you_should_write_a_link'][$dataUserPageLanguage]) ? $page_Lang['you_should_write_a_link'][$dataUserPageLanguage] : $page_Lang['you_should_write_a_link']['english']; ?></div></div>
<div class="note_6"><div class="newnote_4"><?php echo isset($page_Lang['you_should_upload_filter_image'][$dataUserPageLanguage]) ? $page_Lang['you_should_upload_filter_image'][$dataUserPageLanguage] : $page_Lang['you_should_upload_filter_image']['english']; ?></div></div>
<div class="note_7"><div class="newnote_4"><?php echo isset($page_Lang['you_should_select_gif'][$dataUserPageLanguage]) ? $page_Lang['you_should_select_gif'][$dataUserPageLanguage] : $page_Lang['you_should_select_gif']['english']; ?></div></div>
<div class="note_8"><div class="newnote_8"><?php echo isset($page_Lang['you_should_write_location'][$dataUserPageLanguage]) ? $page_Lang['you_should_write_location'][$dataUserPageLanguage] : $page_Lang['you_should_write_location']['english']; ?></div></div>
<div class="note_9"><div class="newnote_4"><?php echo isset($page_Lang['you_can_not_send_empty_watermark_post'][$dataUserPageLanguage]) ? $page_Lang['you_can_not_send_empty_watermark_post'][$dataUserPageLanguage] : $page_Lang['you_can_not_send_empty_watermark_post']['english']; ?></div></div>
<div class="note_10"><div class="newnote_9"><?php echo isset($page_Lang['you_can_not_send_empty_benchmark_post'][$dataUserPageLanguage]) ? $page_Lang['you_can_not_send_empty_benchmark_post'][$dataUserPageLanguage] : $page_Lang['you_can_not_send_empty_benchmark_post']['english']; ?></div></div>
<div class="note_11"><div class="newnote_4"><?php echo isset($page_Lang['music_format'][$dataUserPageLanguage]) ? $page_Lang['music_format'][$dataUserPageLanguage] : $page_Lang['music_format']['english']; ?></div></div>
<div class="note_12"><div class="newnote_3"><?php echo isset($page_Lang['successfully_deleted'][$dataUserPageLanguage]) ? $page_Lang['successfully_deleted'][$dataUserPageLanguage] : $page_Lang['successfully_deleted']['english']; ?></div></div>
<div class="note_12"><div class="newnote_3"><?php echo isset($page_Lang['nobody_see_this_story'][$dataUserPageLanguage]) ? $page_Lang['nobody_see_this_story'][$dataUserPageLanguage] : $page_Lang['nobody_see_this_story']['english']; ?></div></div>
<div class="note_13"><div class="newnote_3"><?php echo isset($page_Lang['an_error_embed'][$dataUserPageLanguage]) ? $page_Lang['an_error_embed'][$dataUserPageLanguage] : $page_Lang['an_error_embed']['english']; ?></div></div>
<div class="note_14"><div class="newnote_9"><?php echo isset($page_Lang['an_error_embed'][$dataUserPageLanguage]) ? $page_Lang['an_error_embed'][$dataUserPageLanguage] : $page_Lang['an_error_embed']['english']; ?></div></div>
<div class="note_15"><div class="newnote_9"><?php echo isset($page_Lang['need_all_fields_filled'][$dataUserPageLanguage]) ? $page_Lang['need_all_fields_filled'][$dataUserPageLanguage] : $page_Lang['need_all_fields_filled']['english']; ?></div></div>
<!--HEADER STARTED-->
...
<?php if ($page == 'newsfeed') {?><div class="XrOey inLeft"><a class="it"><?php echo $hamburgerMenu; ?> </a></div>	<?php }?>
<div class="XrOey" id="searchFriend" data-type="searchPeople"><a class="it"><?php echo $searchIcon; ?> </a></div>
<div class="XrOey"><a class="iti" href="<?php echo $base_url; ?>explore"><?php echo $exploreIcon;
	?></a></div>
