...
if($newdata){ 
  if($amazons3UploadStatus == '1'){
    $final_imagea = 'https://'.$amazons3UploadBucket.'.s3.'.$amazons3UploadRegion.'.amazonaws.com/images/'.$newdata['uploaded_image']; 
  }else{
...
<div class="cart_productcn" id="tc__<?php echo $cartID;?>"> 
   <div class="sp_center sep" data-type="userfirstinfo" data-id="<?php echo $cartProductOwnerUserIDFk;?>"><span><strong><?php echo $page_Lang['product_seller_cart'][$dataUserPageLanguage]; ?></strong> </span><?php echo $productOwnerUserFullName;?></div>
<div class="cart_product_box" id="cart_<?php echo $cartID;?>">
   ...
   <div class="cart_product_informations">
          ...
          <div class="cart_buttons">
               <div class="cart_btn_box hvr-shutter-out-vertical waves-effect waves-green"><a href="<?php echo $cartProductSlug;?>" class="prduct"><?php echo $page_Lang['see_prodct'][$dataUserPageLanguage]; ?></a></div>
               <div class="cart_btn_box left-rightBorder hvr-shutter-out-vertical waves-effect waves-purple orm" data-id ="<?php echo $cartProductID;?>" data-c="<?php echo $cartID;?>" data-u="<?php echo $cartProductOwnerUserIDFk;?>"><?php echo $page_Lang['ord_now'][$dataUserPageLanguage]; ?></div>
               <div class="cart_btn_box hvr-shutter-out-vertical waves-effect waves-red p_delete" data-id="<?php echo $cartID;?>" data-type="delpro"><?php echo $page_Lang['delete_in_cart'][$dataUserPageLanguage]; ?></div>
          </div>
   </div>
</div>
</div>