<div class="social_share_buttons_container">
   <div class="shareonSocial">
         ...
         <li>
            <span class="collapsible-header feeling-icon-getting"><?php echo $page_Lang['f_t_getting'][$dataUserPageLanguage];?></span>
            <span class="collapsible-body">
            <?php 
         ...
         <li>
            <span class="collapsible-header feeling-icon-making"><?php echo $page_Lang['f_t_making'][$dataUserPageLanguage];?></span>
            <span class="collapsible-body"> 
            <?php 
         ...
         <li>
            <div class="collapsible-header feeling-icon-celebrating"><?php echo $page_Lang['f_t_celebrating'][$dataUserPageLanguage];?></div>
            <span class="collapsible-body">
               <?php 
         ...
         <li>
            <span class="collapsible-header feeling-icon-drinking"><?php echo $page_Lang['f_t_drinking'][$dataUserPageLanguage];?></span>
            <span class="collapsible-body">
               <?php 
         ...
         <li>
            <span class="collapsible-header feeling-icon-eating"><?php echo $page_Lang['f_t_eating'][$dataUserPageLanguage];?></span>
            <span class="collapsible-body">
                <?php 
