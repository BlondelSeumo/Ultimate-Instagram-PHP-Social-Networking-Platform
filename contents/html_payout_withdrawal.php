<div class="current_withdrawal">
   ...
   <div class="n_payouts">
       ...
       <div class="vpymnt"><?php echo $requestedpayoutAmount;?><?php echo $currencys[$theMainCurrency];?> <div class="dlr"><?php echo $page_Lang['pay_via'][$dataUserPageLanguage];?> <?php echo $textType;?></div></div>  
       <?php }}?>
