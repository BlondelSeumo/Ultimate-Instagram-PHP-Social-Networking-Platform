...
if ($dataPostType == 'p_image') {
	...
	if ($newdata) {
		...
		if ($amazons3UploadStatus == '1') {
			...
			$fileImage = $base_url . "uploads/images/" . $newdata['uploaded_image'];
