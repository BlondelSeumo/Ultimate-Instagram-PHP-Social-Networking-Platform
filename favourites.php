...
$Dot->Dot_UpdateUserFavouriteStatus($uid);
?> 
...
<div class="th_middle">
 <div class="container"> 
      ...
      <!--MIDDLE STARTED-->
      <div class="cGcGK"> 
      <div class="_81kxQ"><?php echo $page_Lang['added_you_in_favourite_list'][$dataUserPageLanguage];?></div>
      <div class="theVisitors" id="morePostType" data-type="more_whofavourite">
	   <?php 
		  ...
		  if($proSystemStatus == '1'){ 
			  if($dataUserProType == '1'){ 
				  include("contents/thefavouritelist.php");
			  } else{ echo '<div class="mustbepro">'.$page_Lang['mustbepromember'][$dataUserPageLanguage].'</div>'; }
		  }else {
		        include("contents/thefavouritelist.php");
		  }
       ?>
