 ...
 <div class="container"> 
      ...
      <div class="shopping_address">
               <div class="shopping_address_and_user_informations">
                    <div class="shopping_ui_title"><?php echo $page_Lang['p_address_infos'][$dataUserPageLanguage]; ?></div>
                    <div class="shopping_ui_box"><span class="nmsp"><?php echo $page_Lang['p_u_full_name'][$dataUserPageLanguage]; ?> </span><?php echo $profileShoppingFullName;?></div>
                    <div class="shopping_ui_box"><span class="nmsp"><?php echo $page_Lang['u_p_fulladdress'][$dataUserPageLanguage]; ?> </span><?php echo $profileShoppingFullAddress;?></div>
                    <div class="shopping_ui_box"><span class="nmsp"><?php echo $page_Lang['u_p_phone_number'][$dataUserPageLanguage]; ?></span> <?php echo $profileShoppingPhoneNumber;?></div>
                    <div class="shopping_ui_box"><span class="nmsp"><?php echo $page_Lang['u_p_country'][$dataUserPageLanguage]; ?></span> <?php echo isset($dataCountry) ? $Dot->Dot_CountryName($dataCountry) : $page_Lang['y_need_edit'][$dataUserPageLanguage]; ?> </div>
                    <div class="shopping_ui_box"><span class="nmsp"><?php echo $page_Lang['u_p_state'][$dataUserPageLanguage]; ?></span> <?php echo isset($dataState) ? $Dot->Dot_UserState($dataState) : $page_Lang['y_need_edit'][$dataUserPageLanguage]; ?></div>
                    <div class="shopping_ui_box"><span class="nmsp"><?php echo $page_Lang['u_p_city'][$dataUserPageLanguage]; ?></span> <?php echo isset($dataCity) ? $Dot->Dot_UserCity($dataCity) : $page_Lang['y_need_edit'][$dataUserPageLanguage]; ?></div>
                    <div class="shopping_ui_box"><span class="nmsp"><?php echo $page_Lang['u_p_postcode'][$dataUserPageLanguage]; ?></span> <?php echo isset($dataUserPostCode) ? $dataUserPostCode : $page_Lang['y_need_edit'][$dataUserPageLanguage]; ?></div>
                    <div class="shopping_ui_box"><span class="nmsp"><?php echo $page_Lang['u_p_id_or_passkey'][$dataUserPageLanguage]; ?></span> <?php echo isset($dataUserPassportCodeOrIdNumber) ? $dataUserPassportCodeOrIdNumber : $page_Lang['y_need_edit'][$dataUserPageLanguage]; ?></div>
...
<div class="in_sticky">
	<?php include("contents/chatRightSidebarWidget.php");?>
</div>
</div>
<!--/Right-->
