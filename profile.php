...
<div class="section" id="which_user_profile" data-type="profile" data-id="<?php echo $profileUserID; ?>" data-who="<?php echo $ProfileUserName; ?>">
   <div class="main">
    ...
    <div class="profile_cover_container">
        <div class="profile_coverBgGradient" style="background-image:url('<?php echo $ProfileUserCover; ?>');"></div>
        <div id="profile_cover_container">
            <div class="CoverImage img-thumbnail" style="background-image:url('<?php echo $ProfileUserCover; ?>');"></div>
        </div>
    ...
    <div class="xSlty">
         ...
         <div class="pUsrNm"><h1 class="AC5d8 notranslate ttext_" title="<?php echo $ProfileUserFullName; ?>"><?php echo $ProfileUserFullName; ?><?php echo $verifiedBadge; ?></h1> </div>
              ...
              <?php if (!$profileUserHeight && !$profileUserWeight && $profileUserBodyType == 'unspecified' && $profileUserHairColor == 'unspecified' && $profileUserEyeColor == 'unspecified') {} else {?>
                            ...
                            <div class="info_item_box">
                              ...
                              <div class="info_item_answer">
                                <?php if ($profileUserHeight && $userHeightFeature == '1') {echo $profileUserHeight . 'cm';}?>
                                <?php if ($profileUserWeight && $userWeightFeature == '1') {echo ',' . $profileUserWeight . 'kg';}?>
                                <?php if ($profileUserBodyType !== 'unspecified' && $userBodyTypeFeature == '1') {echo ',' . $page_Lang[$profileUserBodyType][$dataUserPageLanguage];}?>
                                <?php if ($profileUserHairColor !== 'unspecified' && $userHairColorFeature == '1') {echo ',' . $page_Lang[$profileUserHairColor][$dataUserPageLanguage];}?>
                                <?php if ($profileUserEyeColor !== 'unspecified' && $userEyeColorFeature == '1') {echo $page_Lang[$profileUserEyeColor][$dataUserPageLanguage];}?>
                                </div>
                            </div>
                              <?php }?>
                         <!--Item FINISHED-->
...
$(document).ready(function() {
  ...
  $("body").on("click", ".crop_image", function(event) {
    $image_crop
      ...
      $(".profile_avatar_image_container").css('background-image', 'url(' + data + ')');
