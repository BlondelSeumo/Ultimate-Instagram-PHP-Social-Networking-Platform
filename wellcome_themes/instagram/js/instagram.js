...
formRegister.on('submit', function(e) {
	...
	if ($.trim(reg_username.val() ) === '' ){
	    ...
	    reg_username.css({'border':'2px solid rgba(231, 231, 231)', 'background':'rgba(255, 255, 255)', 'transition': 'all 0.15s ease-out;'}); 
		reg_username.css({'border-right':'2px solid rgba(231, 231, 231)'});
	}
	if ($.trim(reg_fullname.val() ) === '' ){
	    ...
	    reg_fullname.css({'border':'2px solid rgba(231, 231, 231)', 'background':'rgba(255, 255, 255)', 'transition': 'all 0.15s ease-out;'}); 
		reg_fullname.css({'border-right':'2px solid rgba(231, 231, 231)'});
	}
	if ($.trim(reg_email.val() ) === '' ){
	    ...
	    reg_email.css({'border':'2px solid rgba(231, 231, 231)', 'background':'rgba(255, 255, 255)', 'transition': 'all 0.15s ease-out;'}); 
		reg_email.css({'border-right':'2px solid rgba(231, 231, 231)'});
	}
	if(reg_password.val().length < 8 ){
		...
		return false;
		 ...
		 reg_password.css({'border':'2px solid rgba(231, 231, 231)', 'background':'rgba(255, 255, 255)', 'transition': 'all 0.15s ease-out;'}); 
		 reg_password.css({'border-right':'2px solid rgba(231, 231, 231)'});
