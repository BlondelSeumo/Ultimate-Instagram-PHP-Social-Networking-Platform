...
<div class="divTableCell block" data-post="<?php echo $reportedPostID; ?>">
	<div class="tableincontainer" id="menu_<?php echo $reportID; ?>" style="vertical-align: middle;">
	   <div class="look_at_report border-radius" id="<?php echo $reportID; ?>" data-post="<?php echo $reportedPostID; ?>"></div>
    </div>
</div>
</div>