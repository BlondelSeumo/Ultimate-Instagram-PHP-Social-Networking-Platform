<div class="lang_page_title bold"><?php echo isset($page_Lang['manage_languages'][$dataUserPageLanguage]) ? $page_Lang['manage_languages'][$dataUserPageLanguage] : $page_Lang['manage_languages']['english'];?></div> 
...
<table class="striped highlight">
    <thead>
      <tr>
        <th>ID</th>
        <th><?php echo isset($page_Lang['lang_key_name'][$dataUserPageLanguage]) ? $page_Lang['lang_key_name'][$dataUserPageLanguage] : $page_Lang['lang_key_name']['english'];?></th> 
        <th><?php echo isset($page_Lang['lang_key_value'][$dataUserPageLanguage]) ? $page_Lang['lang_key_value'][$dataUserPageLanguage] : $page_Lang['lang_key_value']['english'];?></th>
        <th><?php echo isset($page_Lang['post_admin_action'][$dataUserPageLanguage]) ? $page_Lang['post_admin_action'][$dataUserPageLanguage] : $page_Lang['post_admin_action']['english'];?></th> 
      </tr>
    </thead>  
...
<tr class="langCur olds body<?php echo $dataLangID;?>" id="post_<?php echo $dataLangID;?>" data-last="<?php echo $dataLangID;?>">  
  ...
  <div class="btn waves-effect waves-light blue edit_lang_values" id="<?php echo $dataLangID;?>" data-type="get_lang" data-key="<?php echo $dataLangKey;?>"><div class="tableincontainer bold" style="text-align:center;font-size:14px;"><?php echo isset($page_Lang['edit_btn'][$dataUserPageLanguage]) ? $page_Lang['edit_btn'][$dataUserPageLanguage] : $page_Lang['edit_btn']['english'];?></div></div>
  <div class="btn waves-effect waves-light red delete_lng" style="margin-left:10px;" id="<?php echo $dataLangID;?>" data-type="del_lang"><div class="tableincontainer bold" style="text-align:center;font-size:14px;"><?php echo isset($page_Lang['delete'][$dataUserPageLanguage]) ? $page_Lang['delete'][$dataUserPageLanguage] : $page_Lang['delete']['english'];?></div></div> 
  </td>
</tr>     
<?php  }; ?>
</tbody> 
