...
if(in_array($pageActive, $activePage)) { 
	...
	if($pageActive == 'live_streamings_features'){
	    $liveStreamingClass = 'class="active activeSetting"';
	}
	if($pageActive == 'completed_orders'){
	    $orderClass = 'class="active activeSetting"';
	}
	...
	if($pageActive == 'manage-social-share-buttons'){
	    $featuresClass = 'class="active activeSetting"';
	} 
