...
<div class="global_right_wrapper">
   <div class="global_box_container_w bgc">
        <div class="general_settings_header_title"><?php echo $page_Lang['comissions_from_market_and_donations'][$dataUserPageLanguage];?></div>
         <div class="row-box-container" id="set_newfeee">
               <!---->
               <span class="setting-box"> 
               <div class="setting-box-global">
                    <span class="input-field col s12"> 
                        <select class="defCurr" data-type="default_currency"> 
                            <?php   
                                foreach($currencys as $value => $val) {
                                  $thisSelected = $value == $theMainCurrency ? "selected='selected'":"";       
               ...
               <!---->
               <span class="setting-box"> 
                   <span class="setSettinginputTitle"><?php echo $page_Lang['write_a_comission_percentage'][$dataUserPageLanguage];?></span>  
                   <div class="column_set_input_box"><input type="text" class="column_inputField chng" id="paymenfee" onkeyup="this.value = this.value.replace(/[^0-9]/g, '').replace(/(\..*)\./g, '$1');" placeholder="<?php echo $page_Lang['write_a_comission_percentage'][$dataUserPageLanguage];?>" value="<?php echo $paymentFEE;?>"></div>
                   <span class="setSettingBoxInfoNote"><?php echo $page_Lang['comission_percentage_applies_all_donations_and_marketproducts'][$dataUserPageLanguage];?></span>
               </span>
               <!----> 
               <!----> 
               <span class="setting-box"> 
                    <span class="setSettinginputTitle"><?php echo $page_Lang['minimum_withdrawal_amount'][$dataUserPageLanguage];?></span>  
                    <div class="column_set_input_box"><input type="text" class="column_inputField send_livebox" id="miminumwithdrawlamount" style="padding-left:30px;" placeholder="<?php echo $page_Lang['write_minimum_withdrawal_amount'][$dataUserPageLanguage];?>" value="<?php echo $minimumWithdrawalAmount;?>"></div>
               </span>
               <!---->
               <!---->
                <div class="setting-box">
                       <div class="column-set_input_box">
                           <div class="saveTheSettings btn waves-effect waves-light blue payment_comission_fee"><?php echo $page_Lang['save_news'][$dataUserPageLanguage];?></div>
                       </div>
                   </div>
                <!---->
        </div>
        <div class="general_settings_header_title_second"><?php echo $page_Lang['paypal_settings'][$dataUserPageLanguage];?></div>
