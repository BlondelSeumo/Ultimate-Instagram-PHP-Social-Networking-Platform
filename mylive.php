           ...
           <!---->
			...
			<div id="live_post_comments" class="liv_comments_feed">
                <div class="live_comments_container">
                     ...
                     <div class="comment_wall" style="display:block;">
                        <div class="newDonatebox uinfSlideInUp dlimam" data-type="donateLiveFrm">
                            <div class="fundraiserBox">
                              <div class="fundraiser"><div class="fundraiser_text"><?php echo $page_Lang['live_sponsoring_event'][$dataUserPageLanguage]; ?></div><div class="fundraiser_note"><?php echo $page_Lang['sponsor_my_profile'][$dataUserPageLanguage]; ?></div></div>
                              <div class="fundraiser_me"><div class="fundrame"><?php echo $page_Lang['be_sponsor'][$dataUserPageLanguage]; ?></div></div>
                            </div>
                        </div>
