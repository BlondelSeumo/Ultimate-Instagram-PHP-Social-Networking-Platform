...
<div class="container">
     ...
     <div class="installation_container">
          ...
          <div class="installation_box_purchase">
               ...
               <!---->
               <div class="installation_box_middle" id="afterpurc">
                       <input type="text" id="purchaseCode" class="purchaseCode" placeholder="Random value!" autofocus/>
               </div>
               <!----> 
               <!---->
					...
					$.ajax({
						  ...
						  success: function(response) {
							  if(response !== '1'){ 
								  ...
								  if(response == '3'){
								        $("#data_server").focus().css({'background-color':'rgb(255, 220, 175)'});  
										$("#afterhost").after('<div class="errors">You cannot leave the host blank.</div>');
								  }
								  if(response == '4'){
								        $("#data_username").focus().css({'background-color':'rgb(255, 220, 175)'});  
										$("#afterusername").after('<div class="errors">You cannot leave the Database Username blank.</div>');
								  }
								  if(response == '5'){
								        $("#data_password").focus().css({'background-color':'rgb(255, 220, 175)'});  
										$("#afterpassword").after('<div class="errors">You cannot leave the Database Password blank.</div>');
								  }
								  if(response == '6'){
								        $("#data_name").focus().css({'background-color':'rgb(255, 220, 175)'});  
										$("#afterdbname").after('<div class="errors">You cannot leave the Database Name blank.</div>');
								  }
								  if(response == '7'){
								      $("#purchaseCode").focus().css({'background-color':'rgb(255, 220, 175)'}); 
									  $("#afterpurc").after('<div class="errors">You cannot leave the purchase code blank.</div>'); 
									  return false;
								  }
								  if(response == '8'){
									  $("#afterpurc").after('<div class="error">This License Key is not correct. Do you need help ? Click here to send me <a href="https://codecanyon.net/item/oobenn-instagram-style-social-networking-script/17048549/support/contact">Support Mail</a>. Or if you do not have a License Key <a href="https://codecanyon.net/item/oobenn-social-networking-platform-like-instagram/17048549?license=regular&open_purchase_for_item_id=17048549&purchasable=source" target="blank_">Click HERE</a> to get License Key.</div>');
									  return false;
								  }
								  if(response == '9'){
									  $("#afterpurc").after('<div class="error">This License Key is currently being used by someone else. License Key can only be used on a website. <a href="https://codecanyon.net/item/oobenn-social-networking-platform-like-instagram/17048549?license=regular&open_purchase_for_item_id=17048549&purchasable=source" target="blank_">Click HERE</a> to get new License Key .</div>');
									  return false;
								  }
								  if(response == '10'){
									  $("#purchaseCode").focus().css({'background-color':'rgb(255, 220, 175)'}); 
								  ...
								  if(response == 'database_error'){
									  $("#afterwebdomain").after('<div class="errordata">There was a problem during installation. Please <a href="https://codecanyon.net/item/oobenn-instagram-style-social-networking-script/17048549/support/contact" target="blank_">CONTACT ME</a>.</div>');	 
								  }
								  if(response == 'server_error'){
									  $("#data_name").focus().css({'background-color':'rgb(255, 220, 175)'});  
									  $("#data_username").focus().css({'background-color':'rgb(255, 220, 175)'});  
									  $("#data_password").focus().css({'background-color':'rgb(255, 220, 175)'});  
								      $("#afterwebdomain").after('<div class="errordata">Some of your information seems to be incorrect for the database, please check your information and try again.</div>');	 
								  }
								  if(response == 'selecting_databae_error'){
									  $("#data_name").focus().css({'background-color':'rgb(255, 220, 175)'});  
									  $("#data_username").focus().css({'background-color':'rgb(255, 220, 175)'});  
									  $("#data_password").focus().css({'background-color':'rgb(255, 220, 175)'});  
								      $("#afterwebdomain").after('<div class="errordata">No Database Selected or Write correct database.</div>');	 
								  }
								  if(response == '2'){
								        $("#website_domain").focus().css({'background-color':'rgb(255, 220, 175)'});  
										$("#afterwebdomain").after('<div class="errors">You cannot leave the website link blank.</div>');
								  }
								  $('.lds-ellipsis').remove();
								  $('.waitaminute').remove();
							  }else{ 
