...
if(in_array($_POST['f'], $postTypes) && in_array($_POST['show'], $WhoCanSee)){
	 ...
	 if($type == 'text'){
	      if(isset($_POST['title']) && isset($_POST['details']) && isset($_POST['tags']) && isset($_POST['show'])){
				...
				if(!empty($postTitle)){
				    $slug = 'p_'.random_code(8).'_'.url_slugies($postTitle);
				}elseif(!empty($postDetails)){
				    $slug = 'p_'.random_code(8).'_'.url_slugies($postDetails);
      ...
      <div class="noteeBox_alert_close"><svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="26" height="26" viewBox="0 0 172 172" style=" fill:#000000;"><g fill="none" fill-rule="nonzero" stroke="none" stroke-width="1" stroke-linecap="butt" stroke-linejoin="miter" stroke-miterlimit="10" stroke-dasharray="" stroke-dashoffset="0" font-family="none" font-weight="none" font-size="none" text-anchor="none" style="mix-blend-mode: normal"><path d="M0,172v-172h172v172z" fill="none"></path><g fill="#ffffff"><path d="M86,14.33333c-39.63167,0 -71.66667,32.035 -71.66667,71.66667c0,39.63167 32.035,71.66667 71.66667,71.66667c39.63167,0 71.66667,-32.035 71.66667,-71.66667c0,-39.63167 -32.035,-71.66667 -71.66667,-71.66667zM119.7335,109.59983c2.80217,2.80217 2.80217,7.3315 0,10.13367c-1.3975,1.3975 -3.23217,2.09983 -5.06683,2.09983c-1.83467,0 -3.66933,-0.70233 -5.06683,-2.09983l-23.59983,-23.59983l-23.59983,23.59983c-1.3975,1.3975 -3.23217,2.09983 -5.06683,2.09983c-1.83467,0 -3.66933,-0.70233 -5.06683,-2.09983c-2.80217,-2.80217 -2.80217,-7.3315 0,-10.13367l23.59983,-23.59983l-23.59983,-23.59983c-2.80217,-2.80217 -2.80217,-7.3315 0,-10.13367c2.80217,-2.80217 7.3315,-2.80217 10.13367,0l23.59983,23.59983l23.59983,-23.59983c2.80217,-2.80217 7.3315,-2.80217 10.13367,0c2.80217,2.80217 2.80217,7.3315 0,10.13367l-23.59983,23.59983z"></path></g></g></svg></div>
				...
				$PostFromData = $Dot->Dot_TextPostSave($uid, $postTitle, $postDetailsHtml, $postTags, $tags,$canSee,$slug,$userFeeling,$dataCountry);  
				if($PostFromData){
	  ...
	  if($type == 'image'){ 
	     if(isset($_POST['uploads']) && isset($_POST['title']) && isset($_POST['details']) && isset($_POST['tags']) && isset($_POST['show'])){
				...
				$postTags  = mysqli_real_escape_string($db, $_POST['tags']);
				$canSee = mysqli_real_escape_string($db, $_POST['show']);   
				$removeSpecialChars = preg_replace('/[^0-9,]/', '', mysqli_real_escape_string($db, $_POST['uploads']));
				$UploadValues =  rtrim(preg_replace('/,+/', ',',implode(',',array_unique(explode(',',$removeSpecialChars)))),',');
				$userFeeling = mysqli_real_escape_string($db, $_POST['myFeeling']);
				$tags = hashtag($postTags);
				$postDetailsHtml = htmlcode($postDetails);
				if(!empty($postTitle)){
      ...
      <div class="noteeBox_alert_close"><svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="26" height="26" viewBox="0 0 172 172" style=" fill:#000000;"><g fill="none" fill-rule="nonzero" stroke="none" stroke-width="1" stroke-linecap="butt" stroke-linejoin="miter" stroke-miterlimit="10" stroke-dasharray="" stroke-dashoffset="0" font-family="none" font-weight="none" font-size="none" text-anchor="none" style="mix-blend-mode: normal"><path d="M0,172v-172h172v172z" fill="none"></path><g fill="#ffffff"><path d="M86,14.33333c-39.63167,0 -71.66667,32.035 -71.66667,71.66667c0,39.63167 32.035,71.66667 71.66667,71.66667c39.63167,0 71.66667,-32.035 71.66667,-71.66667c0,-39.63167 -32.035,-71.66667 -71.66667,-71.66667zM119.7335,109.59983c2.80217,2.80217 2.80217,7.3315 0,10.13367c-1.3975,1.3975 -3.23217,2.09983 -5.06683,2.09983c-1.83467,0 -3.66933,-0.70233 -5.06683,-2.09983l-23.59983,-23.59983l-23.59983,23.59983c-1.3975,1.3975 -3.23217,2.09983 -5.06683,2.09983c-1.83467,0 -3.66933,-0.70233 -5.06683,-2.09983c-2.80217,-2.80217 -2.80217,-7.3315 0,-10.13367l23.59983,-23.59983l-23.59983,-23.59983c-2.80217,-2.80217 -2.80217,-7.3315 0,-10.13367c2.80217,-2.80217 7.3315,-2.80217 10.13367,0l23.59983,23.59983l23.59983,-23.59983c2.80217,-2.80217 7.3315,-2.80217 10.13367,0c2.80217,2.80217 2.80217,7.3315 0,10.13367l-23.59983,23.59983z"></path></g></g></svg></div>
				...
				$PostFromData = $Dot->Dot_ImagePostSave($uid, $postTitle, $postDetailsHtml, $postTags, $tags,$canSee,$UploadValues,$slug,$userFeeling,$dataCountry); 
				if($PostFromData){
					$mentionPostID = $PostFromData['user_post_id'];
	  ...
	  if($type == 'link'){  
		if(isset($_POST['l_title']) && isset($_POST['l_summary']) && isset($_POST['p_d']) && isset($_POST['show']) && isset($_POST['tag']) && isset($_POST['ln']) && isset($_POST['tumb']) && isset($_POST['min'])){
				...
				if(!empty($postLinkTitle)){
				    $slug = 'p_'.random_code(8).'_'.url_slugies($postLinkTitle);
				}elseif(!empty($postDescription)){
				    $slug = 'p_'.random_code(8).'_'.url_slugies($postDescription);
      ...
      <div class="noteeBox_alert_close"><svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="26" height="26" viewBox="0 0 172 172" style=" fill:#000000;"><g fill="none" fill-rule="nonzero" stroke="none" stroke-width="1" stroke-linecap="butt" stroke-linejoin="miter" stroke-miterlimit="10" stroke-dasharray="" stroke-dashoffset="0" font-family="none" font-weight="none" font-size="none" text-anchor="none" style="mix-blend-mode: normal"><path d="M0,172v-172h172v172z" fill="none"></path><g fill="#ffffff"><path d="M86,14.33333c-39.63167,0 -71.66667,32.035 -71.66667,71.66667c0,39.63167 32.035,71.66667 71.66667,71.66667c39.63167,0 71.66667,-32.035 71.66667,-71.66667c0,-39.63167 -32.035,-71.66667 -71.66667,-71.66667zM119.7335,109.59983c2.80217,2.80217 2.80217,7.3315 0,10.13367c-1.3975,1.3975 -3.23217,2.09983 -5.06683,2.09983c-1.83467,0 -3.66933,-0.70233 -5.06683,-2.09983l-23.59983,-23.59983l-23.59983,23.59983c-1.3975,1.3975 -3.23217,2.09983 -5.06683,2.09983c-1.83467,0 -3.66933,-0.70233 -5.06683,-2.09983c-2.80217,-2.80217 -2.80217,-7.3315 0,-10.13367l23.59983,-23.59983l-23.59983,-23.59983c-2.80217,-2.80217 -2.80217,-7.3315 0,-10.13367c2.80217,-2.80217 7.3315,-2.80217 10.13367,0l23.59983,23.59983l23.59983,-23.59983c2.80217,-2.80217 7.3315,-2.80217 10.13367,0c2.80217,2.80217 2.80217,7.3315 0,10.13367l-23.59983,23.59983z"></path></g></g></svg></div>
				...
				$PostFromData = $Dot->Dot_LinkPostSave($uid,$postLinkTitle, $postLinkDescription,$canSee, $postTags, $postLinkLink, $postLinkimg, $tags, $postDetailsHtml,$postMiniLink,$slug,$userFeeling,$dataCountry); 
				if($PostFromData){
				    $mentionPostID = $PostFromData['user_post_id'];
      ...
      <div class="noteeBox_alert_close"><svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="26" height="26" viewBox="0 0 172 172" style=" fill:#000000;"><g fill="none" fill-rule="nonzero" stroke="none" stroke-width="1" stroke-linecap="butt" stroke-linejoin="miter" stroke-miterlimit="10" stroke-dasharray="" stroke-dashoffset="0" font-family="none" font-weight="none" font-size="none" text-anchor="none" style="mix-blend-mode: normal"><path d="M0,172v-172h172v172z" fill="none"></path><g fill="#ffffff"><path d="M86,14.33333c-39.63167,0 -71.66667,32.035 -71.66667,71.66667c0,39.63167 32.035,71.66667 71.66667,71.66667c39.63167,0 71.66667,-32.035 71.66667,-71.66667c0,-39.63167 -32.035,-71.66667 -71.66667,-71.66667zM119.7335,109.59983c2.80217,2.80217 2.80217,7.3315 0,10.13367c-1.3975,1.3975 -3.23217,2.09983 -5.06683,2.09983c-1.83467,0 -3.66933,-0.70233 -5.06683,-2.09983l-23.59983,-23.59983l-23.59983,23.59983c-1.3975,1.3975 -3.23217,2.09983 -5.06683,2.09983c-1.83467,0 -3.66933,-0.70233 -5.06683,-2.09983c-2.80217,-2.80217 -2.80217,-7.3315 0,-10.13367l23.59983,-23.59983l-23.59983,-23.59983c-2.80217,-2.80217 -2.80217,-7.3315 0,-10.13367c2.80217,-2.80217 7.3315,-2.80217 10.13367,0l23.59983,23.59983l23.59983,-23.59983c2.80217,-2.80217 7.3315,-2.80217 10.13367,0c2.80217,2.80217 2.80217,7.3315 0,10.13367l-23.59983,23.59983z"></path></g></g></svg></div>
			   ...
			   $PostFromData = $Dot->Dot_VideoPostSave($uid, $postTitle, $postDetailsHtml, $postTags, $tags,$canSee,$UploadeVideoID,$slug,$userFeeling,$videoScreenShot,$dataCountry); 
			   if($PostFromData){
			       $mentionPostID = $PostFromData['user_post_id'];
			       $Dot->Dot_InsertMentionedUsersForPost($uid,$postDetails, $type, $mentionPostID, $dataUsername);  
				   if($pointVoteStatus == '1'){$addPoint = $Dot->Dot_AddPoint($uid, 'post', $pointPost,$mentionPostID);} 
      ...
      <div class="noteeBox_alert_close"><svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="26" height="26" viewBox="0 0 172 172" style=" fill:#000000;"><g fill="none" fill-rule="nonzero" stroke="none" stroke-width="1" stroke-linecap="butt" stroke-linejoin="miter" stroke-miterlimit="10" stroke-dasharray="" stroke-dashoffset="0" font-family="none" font-weight="none" font-size="none" text-anchor="none" style="mix-blend-mode: normal"><path d="M0,172v-172h172v172z" fill="none"></path><g fill="#ffffff"><path d="M86,14.33333c-39.63167,0 -71.66667,32.035 -71.66667,71.66667c0,39.63167 32.035,71.66667 71.66667,71.66667c39.63167,0 71.66667,-32.035 71.66667,-71.66667c0,-39.63167 -32.035,-71.66667 -71.66667,-71.66667zM119.7335,109.59983c2.80217,2.80217 2.80217,7.3315 0,10.13367c-1.3975,1.3975 -3.23217,2.09983 -5.06683,2.09983c-1.83467,0 -3.66933,-0.70233 -5.06683,-2.09983l-23.59983,-23.59983l-23.59983,23.59983c-1.3975,1.3975 -3.23217,2.09983 -5.06683,2.09983c-1.83467,0 -3.66933,-0.70233 -5.06683,-2.09983c-2.80217,-2.80217 -2.80217,-7.3315 0,-10.13367l23.59983,-23.59983l-23.59983,-23.59983c-2.80217,-2.80217 -2.80217,-7.3315 0,-10.13367c2.80217,-2.80217 7.3315,-2.80217 10.13367,0l23.59983,23.59983l23.59983,-23.59983c2.80217,-2.80217 7.3315,-2.80217 10.13367,0c2.80217,2.80217 2.80217,7.3315 0,10.13367l-23.59983,23.59983z"></path></g></g></svg></div>
			   ...
			   $PostFromData = $Dot->Dot_MusicPostSave($uid, $postTitle, $postDetailsHtml, $postTags, $tags,$canSee,$UploadeMusicID,$slug,$userFeeling,$dataCountry); 
			   if($PostFromData){
				  $mentionPostID = $PostFromData['user_post_id'];
				  $Dot->Dot_InsertMentionedUsersForPost($uid,$postDetails, $type, $mentionPostID, $dataUsername); 
				  if($pointVoteStatus == '1'){$addPoint = $Dot->Dot_AddPoint($uid, 'post', $pointPost,$mentionPostID);} 
      ...
      <div class="noteeBox_alert_close"><svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="26" height="26" viewBox="0 0 172 172" style=" fill:#000000;"><g fill="none" fill-rule="nonzero" stroke="none" stroke-width="1" stroke-linecap="butt" stroke-linejoin="miter" stroke-miterlimit="10" stroke-dasharray="" stroke-dashoffset="0" font-family="none" font-weight="none" font-size="none" text-anchor="none" style="mix-blend-mode: normal"><path d="M0,172v-172h172v172z" fill="none"></path><g fill="#ffffff"><path d="M86,14.33333c-39.63167,0 -71.66667,32.035 -71.66667,71.66667c0,39.63167 32.035,71.66667 71.66667,71.66667c39.63167,0 71.66667,-32.035 71.66667,-71.66667c0,-39.63167 -32.035,-71.66667 -71.66667,-71.66667zM119.7335,109.59983c2.80217,2.80217 2.80217,7.3315 0,10.13367c-1.3975,1.3975 -3.23217,2.09983 -5.06683,2.09983c-1.83467,0 -3.66933,-0.70233 -5.06683,-2.09983l-23.59983,-23.59983l-23.59983,23.59983c-1.3975,1.3975 -3.23217,2.09983 -5.06683,2.09983c-1.83467,0 -3.66933,-0.70233 -5.06683,-2.09983c-2.80217,-2.80217 -2.80217,-7.3315 0,-10.13367l23.59983,-23.59983l-23.59983,-23.59983c-2.80217,-2.80217 -2.80217,-7.3315 0,-10.13367c2.80217,-2.80217 7.3315,-2.80217 10.13367,0l23.59983,23.59983l23.59983,-23.59983c2.80217,-2.80217 7.3315,-2.80217 10.13367,0c2.80217,2.80217 2.80217,7.3315 0,10.13367l-23.59983,23.59983z"></path></g></g></svg></div>
				...
				$PostFromData = $Dot->Dot_FilteredImagePostSave($uid, $postTitle, $postDetailsHtml, $postTags, $tags,$canSee,$UploadValues,$filter,$slug,$userFeeling,$dataCountry);
				if($PostFromData){
				    $mentionPostID = $PostFromData['user_post_id'];
				    $Dot->Dot_InsertMentionedUsersForPost($uid,$postDetails, $type, $mentionPostID, $dataUsername); 
					if($pointVoteStatus == '1'){$addPoint = $Dot->Dot_AddPoint($uid, 'post', $pointPost,$mentionPostID);} 
      ...
      <div class="noteeBox_alert_close"><svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="26" height="26" viewBox="0 0 172 172" style=" fill:#000000;"><g fill="none" fill-rule="nonzero" stroke="none" stroke-width="1" stroke-linecap="butt" stroke-linejoin="miter" stroke-miterlimit="10" stroke-dasharray="" stroke-dashoffset="0" font-family="none" font-weight="none" font-size="none" text-anchor="none" style="mix-blend-mode: normal"><path d="M0,172v-172h172v172z" fill="none"></path><g fill="#ffffff"><path d="M86,14.33333c-39.63167,0 -71.66667,32.035 -71.66667,71.66667c0,39.63167 32.035,71.66667 71.66667,71.66667c39.63167,0 71.66667,-32.035 71.66667,-71.66667c0,-39.63167 -32.035,-71.66667 -71.66667,-71.66667zM119.7335,109.59983c2.80217,2.80217 2.80217,7.3315 0,10.13367c-1.3975,1.3975 -3.23217,2.09983 -5.06683,2.09983c-1.83467,0 -3.66933,-0.70233 -5.06683,-2.09983l-23.59983,-23.59983l-23.59983,23.59983c-1.3975,1.3975 -3.23217,2.09983 -5.06683,2.09983c-1.83467,0 -3.66933,-0.70233 -5.06683,-2.09983c-2.80217,-2.80217 -2.80217,-7.3315 0,-10.13367l23.59983,-23.59983l-23.59983,-23.59983c-2.80217,-2.80217 -2.80217,-7.3315 0,-10.13367c2.80217,-2.80217 7.3315,-2.80217 10.13367,0l23.59983,23.59983l23.59983,-23.59983c2.80217,-2.80217 7.3315,-2.80217 10.13367,0c2.80217,2.80217 2.80217,7.3315 0,10.13367l-23.59983,23.59983z"></path></g></g></svg></div>
				...
				$headers = get_headers($animateImage, 1);  
				 if (strpos($headers['Content-Type'], 'image/') !== false) {
						$PostFromData = $Dot->Dot_GifPostSave($uid, $postTitle, $postDetailsHtml, $postTags, $tags,$canSee, $animateImage,$slug,$userFeeling, $dataCountry); 
						if($PostFromData){
				            $mentionPostID = $PostFromData['user_post_id'];
						    $InsertMentions = $Dot->Dot_InsertMentionedUsersForPost($uid,$postDetails, $type, $mentionPostID, $dataUsername); 
							if($pointVoteStatus == '1'){$addPoint = $Dot->Dot_AddPoint($uid, 'post', $pointPost,$mentionPostID);} 
      ...
      <div class="noteeBox_alert_close"><svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="26" height="26" viewBox="0 0 172 172" style=" fill:#000000;"><g fill="none" fill-rule="nonzero" stroke="none" stroke-width="1" stroke-linecap="butt" stroke-linejoin="miter" stroke-miterlimit="10" stroke-dasharray="" stroke-dashoffset="0" font-family="none" font-weight="none" font-size="none" text-anchor="none" style="mix-blend-mode: normal"><path d="M0,172v-172h172v172z" fill="none"></path><g fill="#ffffff"><path d="M86,14.33333c-39.63167,0 -71.66667,32.035 -71.66667,71.66667c0,39.63167 32.035,71.66667 71.66667,71.66667c39.63167,0 71.66667,-32.035 71.66667,-71.66667c0,-39.63167 -32.035,-71.66667 -71.66667,-71.66667zM119.7335,109.59983c2.80217,2.80217 2.80217,7.3315 0,10.13367c-1.3975,1.3975 -3.23217,2.09983 -5.06683,2.09983c-1.83467,0 -3.66933,-0.70233 -5.06683,-2.09983l-23.59983,-23.59983l-23.59983,23.59983c-1.3975,1.3975 -3.23217,2.09983 -5.06683,2.09983c-1.83467,0 -3.66933,-0.70233 -5.06683,-2.09983c-2.80217,-2.80217 -2.80217,-7.3315 0,-10.13367l23.59983,-23.59983l-23.59983,-23.59983c-2.80217,-2.80217 -2.80217,-7.3315 0,-10.13367c2.80217,-2.80217 7.3315,-2.80217 10.13367,0l23.59983,23.59983l23.59983,-23.59983c2.80217,-2.80217 7.3315,-2.80217 10.13367,0c2.80217,2.80217 2.80217,7.3315 0,10.13367l-23.59983,23.59983z"></path></g></g></svg></div>
				...
				$PostFromData = $Dot->Dot_LocationPostSave($uid, $postLocationPlace, $postAboutLocation, $postTags, $tags,$canSee, $postLat, $postLong,$slug,$userFeeling, $dataCountry); 
				if($PostFromData){
				    $mentionPostID = $PostFromData['user_post_id'];
				    $InsertMentions = $Dot->Dot_InsertMentionedUsersForPost($uid,$postDetails, $type, $mentionPostID, $dataUsername); 
					if($pointVoteStatus == '1'){$addPoint = $Dot->Dot_AddPoint($uid, 'post', $pointPost,$mentionPostID);} 
      ...
      <div class="noteeBox_alert_close"><svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="26" height="26" viewBox="0 0 172 172" style=" fill:#000000;"><g fill="none" fill-rule="nonzero" stroke="none" stroke-width="1" stroke-linecap="butt" stroke-linejoin="miter" stroke-miterlimit="10" stroke-dasharray="" stroke-dashoffset="0" font-family="none" font-weight="none" font-size="none" text-anchor="none" style="mix-blend-mode: normal"><path d="M0,172v-172h172v172z" fill="none"></path><g fill="#ffffff"><path d="M86,14.33333c-39.63167,0 -71.66667,32.035 -71.66667,71.66667c0,39.63167 32.035,71.66667 71.66667,71.66667c39.63167,0 71.66667,-32.035 71.66667,-71.66667c0,-39.63167 -32.035,-71.66667 -71.66667,-71.66667zM119.7335,109.59983c2.80217,2.80217 2.80217,7.3315 0,10.13367c-1.3975,1.3975 -3.23217,2.09983 -5.06683,2.09983c-1.83467,0 -3.66933,-0.70233 -5.06683,-2.09983l-23.59983,-23.59983l-23.59983,23.59983c-1.3975,1.3975 -3.23217,2.09983 -5.06683,2.09983c-1.83467,0 -3.66933,-0.70233 -5.06683,-2.09983c-2.80217,-2.80217 -2.80217,-7.3315 0,-10.13367l23.59983,-23.59983l-23.59983,-23.59983c-2.80217,-2.80217 -2.80217,-7.3315 0,-10.13367c2.80217,-2.80217 7.3315,-2.80217 10.13367,0l23.59983,23.59983l23.59983,-23.59983c2.80217,-2.80217 7.3315,-2.80217 10.13367,0c2.80217,2.80217 2.80217,7.3315 0,10.13367l-23.59983,23.59983z"></path></g></g></svg></div>
				...
				$PostFromData = $Dot->Dot_WaterMarkPostSave($uid, $postDetailsHtml, $postTags, $tags,$canSee,$slug,$waterMarkID,$userFeeling,$dataCountry); 
				if($PostFromData){
				    $mentionPostID = $PostFromData['user_post_id'];
				    $InsertMentions = $Dot->Dot_InsertMentionedUsersForPost($uid,$postDetails, $type, $mentionPostID, $dataUsername); 
					if($pointVoteStatus == '1'){$addPoint = $Dot->Dot_AddPoint($uid, 'post', $pointPost,$mentionPostID);} 
      ...
      <div class="noteeBox_alert_close"><svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="26" height="26" viewBox="0 0 172 172" style=" fill:#000000;"><g fill="none" fill-rule="nonzero" stroke="none" stroke-width="1" stroke-linecap="butt" stroke-linejoin="miter" stroke-miterlimit="10" stroke-dasharray="" stroke-dashoffset="0" font-family="none" font-weight="none" font-size="none" text-anchor="none" style="mix-blend-mode: normal"><path d="M0,172v-172h172v172z" fill="none"></path><g fill="#ffffff"><path d="M86,14.33333c-39.63167,0 -71.66667,32.035 -71.66667,71.66667c0,39.63167 32.035,71.66667 71.66667,71.66667c39.63167,0 71.66667,-32.035 71.66667,-71.66667c0,-39.63167 -32.035,-71.66667 -71.66667,-71.66667zM119.7335,109.59983c2.80217,2.80217 2.80217,7.3315 0,10.13367c-1.3975,1.3975 -3.23217,2.09983 -5.06683,2.09983c-1.83467,0 -3.66933,-0.70233 -5.06683,-2.09983l-23.59983,-23.59983l-23.59983,23.59983c-1.3975,1.3975 -3.23217,2.09983 -5.06683,2.09983c-1.83467,0 -3.66933,-0.70233 -5.06683,-2.09983c-2.80217,-2.80217 -2.80217,-7.3315 0,-10.13367l23.59983,-23.59983l-23.59983,-23.59983c-2.80217,-2.80217 -2.80217,-7.3315 0,-10.13367c2.80217,-2.80217 7.3315,-2.80217 10.13367,0l23.59983,23.59983l23.59983,-23.59983c2.80217,-2.80217 7.3315,-2.80217 10.13367,0c2.80217,2.80217 2.80217,7.3315 0,10.13367l-23.59983,23.59983z"></path></g></g></svg></div>
				...
				if($num_tags == 2 && is_numeric($checkNumeric)){
						$PostFromData = $Dot->Dot_WhichImagePostSave($uid, $postTitle, $postDetailsHtml, $postTags, $tags,$canSee,$UploadValues,$slug,$whichCategory,$userFeeling,$dataCountry);
						if($PostFromData){
						    $mentionPostID = $PostFromData['user_post_id'];
						    $Dot->Dot_InsertMentionedUsersForPost($uid,$postDetails, $type, $mentionPostID, $dataUsername); 
							if($pointVoteStatus == '1'){$addPoint = $Dot->Dot_AddPoint($uid, 'post', $pointPost,$mentionPostID);} 
      ...
      <div class="noteeBox_alert_close"><svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="26" height="26" viewBox="0 0 172 172" style=" fill:#000000;"><g fill="none" fill-rule="nonzero" stroke="none" stroke-width="1" stroke-linecap="butt" stroke-linejoin="miter" stroke-miterlimit="10" stroke-dasharray="" stroke-dashoffset="0" font-family="none" font-weight="none" font-size="none" text-anchor="none" style="mix-blend-mode: normal"><path d="M0,172v-172h172v172z" fill="none"></path><g fill="#ffffff"><path d="M86,14.33333c-39.63167,0 -71.66667,32.035 -71.66667,71.66667c0,39.63167 32.035,71.66667 71.66667,71.66667c39.63167,0 71.66667,-32.035 71.66667,-71.66667c0,-39.63167 -32.035,-71.66667 -71.66667,-71.66667zM119.7335,109.59983c2.80217,2.80217 2.80217,7.3315 0,10.13367c-1.3975,1.3975 -3.23217,2.09983 -5.06683,2.09983c-1.83467,0 -3.66933,-0.70233 -5.06683,-2.09983l-23.59983,-23.59983l-23.59983,23.59983c-1.3975,1.3975 -3.23217,2.09983 -5.06683,2.09983c-1.83467,0 -3.66933,-0.70233 -5.06683,-2.09983c-2.80217,-2.80217 -2.80217,-7.3315 0,-10.13367l23.59983,-23.59983l-23.59983,-23.59983c-2.80217,-2.80217 -2.80217,-7.3315 0,-10.13367c2.80217,-2.80217 7.3315,-2.80217 10.13367,0l23.59983,23.59983l23.59983,-23.59983c2.80217,-2.80217 7.3315,-2.80217 10.13367,0c2.80217,2.80217 2.80217,7.3315 0,10.13367l-23.59983,23.59983z"></path></g></g></svg></div>
						...
						$PostFromData = $Dot->Dot_BeforeAfterImagePostSave($uid, $postTitle, $postDetailsHtml, $postTags, $tags,$canSee,$lastComma,$slug,$userFeeling,$dataCountry);
						if($PostFromData){
						    $mentionPostID = $PostFromData['user_post_id'];
						    $Dot->Dot_InsertMentionedUsersForPost($uid,$postDetails, $type, $mentionPostID, $dataUsername); 
							if($pointVoteStatus == '1'){$addPoint = $Dot->Dot_AddPoint($uid, 'post', $pointPost,$mentionPostID);} 
...
if(in_array($_POST['mpro'], $postTypes)){ 
	 ...
	 $chCurrencys = array( "USD",  "AUD",  "EUR",  "BRL",  "CAD",  "CZK",  "DKK",  "HKD",  "HUF",  "INR",  "ILS",  "JPY",  "MYR",  "MXN",  "TWD",  "NZD",  "NOK",  "PHP",  "PLN",  "GBP",  "RUB",  "SGD",   "CHF",  "THB",  "TRY",  "ZAR",  "NGN"); 
	   //Create New Image Post
	  if($type == 'newProduct'){  
	     if(isset($_POST['ppric']) && isset($_POST['pti']) && isset($_POST['prid']) && isset($_POST['prCat']) && isset($_POST['uploads']) && isset($_POST['mstatus']) && isset($_POST['place']) && in_array(isset($_POST['curncy']), $chCurrencys)){
				...
				$productCurrencys = mysqli_real_escape_string($db, $_POST['curncy']);
				$productDescriptionHtml = htmlcode($productDescription);
				if(!empty($productTitle)){
				    $slug = 'p_'.random_code(8).'_'.url_slugies($productTitle);
				}elseif(!empty($productDescription)){
				    $slug = 'p_'.random_code(8).'_'.url_slugies($productDescription);
      ...
      <div class="noteeBox_alert_close"><svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="26" height="26" viewBox="0 0 172 172" style=" fill:#000000;"><g fill="none" fill-rule="nonzero" stroke="none" stroke-width="1" stroke-linecap="butt" stroke-linejoin="miter" stroke-miterlimit="10" stroke-dasharray="" stroke-dashoffset="0" font-family="none" font-weight="none" font-size="none" text-anchor="none" style="mix-blend-mode: normal"><path d="M0,172v-172h172v172z" fill="none"></path><g fill="#ffffff"><path d="M86,14.33333c-39.63167,0 -71.66667,32.035 -71.66667,71.66667c0,39.63167 32.035,71.66667 71.66667,71.66667c39.63167,0 71.66667,-32.035 71.66667,-71.66667c0,-39.63167 -32.035,-71.66667 -71.66667,-71.66667zM119.7335,109.59983c2.80217,2.80217 2.80217,7.3315 0,10.13367c-1.3975,1.3975 -3.23217,2.09983 -5.06683,2.09983c-1.83467,0 -3.66933,-0.70233 -5.06683,-2.09983l-23.59983,-23.59983l-23.59983,23.59983c-1.3975,1.3975 -3.23217,2.09983 -5.06683,2.09983c-1.83467,0 -3.66933,-0.70233 -5.06683,-2.09983c-2.80217,-2.80217 -2.80217,-7.3315 0,-10.13367l23.59983,-23.59983l-23.59983,-23.59983c-2.80217,-2.80217 -2.80217,-7.3315 0,-10.13367c2.80217,-2.80217 7.3315,-2.80217 10.13367,0l23.59983,23.59983l23.59983,-23.59983c2.80217,-2.80217 7.3315,-2.80217 10.13367,0c2.80217,2.80217 2.80217,7.3315 0,10.13367l-23.59983,23.59983z"></path></g></g></svg></div>
				...
				if(empty($productImageValues) || empty($productTitle) || empty($productDescription) || empty($productCategory) || empty($productPrice) || empty($productMessageStatus) || empty($productPlace) || empty($productCurrencys)){ 
      ...
      <div class="noteeBox_alert_close"><svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="26" height="26" viewBox="0 0 172 172" style=" fill:#000000;"><g fill="none" fill-rule="nonzero" stroke="none" stroke-width="1" stroke-linecap="butt" stroke-linejoin="miter" stroke-miterlimit="10" stroke-dasharray="" stroke-dashoffset="0" font-family="none" font-weight="none" font-size="none" text-anchor="none" style="mix-blend-mode: normal"><path d="M0,172v-172h172v172z" fill="none"></path><g fill="#ffffff"><path d="M86,14.33333c-39.63167,0 -71.66667,32.035 -71.66667,71.66667c0,39.63167 32.035,71.66667 71.66667,71.66667c39.63167,0 71.66667,-32.035 71.66667,-71.66667c0,-39.63167 -32.035,-71.66667 -71.66667,-71.66667zM119.7335,109.59983c2.80217,2.80217 2.80217,7.3315 0,10.13367c-1.3975,1.3975 -3.23217,2.09983 -5.06683,2.09983c-1.83467,0 -3.66933,-0.70233 -5.06683,-2.09983l-23.59983,-23.59983l-23.59983,23.59983c-1.3975,1.3975 -3.23217,2.09983 -5.06683,2.09983c-1.83467,0 -3.66933,-0.70233 -5.06683,-2.09983c-2.80217,-2.80217 -2.80217,-7.3315 0,-10.13367l23.59983,-23.59983l-23.59983,-23.59983c-2.80217,-2.80217 -2.80217,-7.3315 0,-10.13367c2.80217,-2.80217 7.3315,-2.80217 10.13367,0l23.59983,23.59983l23.59983,-23.59983c2.80217,-2.80217 7.3315,-2.80217 10.13367,0c2.80217,2.80217 2.80217,7.3315 0,10.13367l-23.59983,23.59983z"></path></g></g></svg></div>
				...
				$resT = file_get_contents('https://www.iplocate.io/api/lookup/' . $uip);
				$resT = json_decode($resT);

				$LocationUserLatitude = isset($resT->latitude) ? $resT->latitude : NULL;
				$LocationUserLongitude = isset($resT->longitude) ? $resT->longitude : NULL;
				$PostFromData = $Dot->Dot_MarketPlaceProductSave($uid, $productTitle, $productDescriptionHtml,$productImageValues,$slug, $productCategory,$productPrice,$productMessageStatus, $productPlace, $productCurrencys,$LocationUserLatitude,$LocationUserLongitude,$dataCountry); 
				if($PostFromData){ 
