...
if($AllMarketProducts){
	foreach($AllMarketProducts as $m_d){
		...
		$product_Currency = isset($m_d['product_currency']) ? $m_d['product_currency'] : $theMainCurrency;
		$sg_ProductCurrency = $currencys[$product_Currency];
		...
		$hasDiscount =  '';
		$p_editButton = '';
		$moneyFormat = $Dot->Dot_restyle_text($productNormalPrice);
		$p_pric = $moneyFormat;
		...
		if($productDiscount){$moneyFormatDiscount = $Dot->Dot_restyle_text($productNormalPrice); $hasDiscount = '<div class="produc_discount">'.$moneyFormatDiscount.' '.$product_Currency.'</div>'; $p_pric = $Dot->Dot_restyle_text($productDiscount);}
		echo '
		<!--Product STARTED-->
				 <div class="product_container">
				  <div class="product_main">'.$p_editButton.'
				   <a href="'.$dataPostSlug.'" class="prduct">
					 ...
					 <div class="product_information">
						 ...
						 <div class="product_pices" style="color:#'.$ProductcolorText.';">'.$sg_ProductCurrency.''.$p_pric.'</div>
					 </div>
					  </a>
					 </div>
				 </div>
