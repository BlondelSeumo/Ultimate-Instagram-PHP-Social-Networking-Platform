...
$theMainCurrency = $duhovitOut['default_currency'];
$currencys = array(
  "USD" => '$',
  "AUD" => '$',
  "EUR" => '€',
...
$amazons3UploadStatus = $duhovitOut['s3_status'];
$amazons3UploadSecretKey = $duhovitOut['s3_secret_key'];
$amazons3UploadKey = $duhovitOut['s3_key'];
$amazons3UploadBucket = $duhovitOut['s3_bucket'];
$amazons3UploadRegion = $duhovitOut['s3_region']; 
?>